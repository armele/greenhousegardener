...
import com.deathfrog.greenhousegardener.core.colony.buildings.modules.WorkshopModule.OutputTarget;
...
{
    private static final String TAG_MOD_DATA = GreenhouseGardenerMod.MODID;
